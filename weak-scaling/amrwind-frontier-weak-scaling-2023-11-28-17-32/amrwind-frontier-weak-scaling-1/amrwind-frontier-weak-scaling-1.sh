...
#SBATCH -J amrwind-frontier-weak-scaling-1
#SBATCH -o %x.o%j
#SBATCH -A CFD116
#SBATCH -t 30
#SBATCH -p batch
...
echo "Running with 8 ranks per node and 1 ranks per GPU on 1 nodes for a total of 8 ranks and 8 total GPUs with 8 AMR-Wind ranks..."
