...
#SBATCH -J amrwind-frontier-weak-scaling-2
#SBATCH -o %x.o%j
#SBATCH -A CFD116
#SBATCH -t 30
#SBATCH -p batch
...
echo "Running with 8 ranks per node and 1 ranks per GPU on 2 nodes for a total of 16 ranks and 16 total GPUs with 16 AMR-Wind ranks..."
