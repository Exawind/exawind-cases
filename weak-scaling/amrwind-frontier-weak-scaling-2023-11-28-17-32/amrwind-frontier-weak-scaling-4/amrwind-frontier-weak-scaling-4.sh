...
#SBATCH -J amrwind-frontier-weak-scaling-4
#SBATCH -o %x.o%j
#SBATCH -A CFD116
#SBATCH -t 30
#SBATCH -p batch
...
echo "Running with 8 ranks per node and 1 ranks per GPU on 8 nodes for a total of 64 ranks and 64 total GPUs with 64 AMR-Wind ranks..."
