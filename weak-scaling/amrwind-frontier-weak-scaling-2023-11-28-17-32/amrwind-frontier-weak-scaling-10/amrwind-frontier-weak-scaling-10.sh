...
#SBATCH -J amrwind-frontier-weak-scaling-10
#SBATCH -o %x.o%j
#SBATCH -A CFD116
#SBATCH -t 30
#SBATCH -p batch
...
echo "Running with 8 ranks per node and 1 ranks per GPU on 512 nodes for a total of 4096 ranks and 4096 total GPUs with 4096 AMR-Wind ranks..."
