...
#SBATCH -J amrwind-frontier-weak-scaling-9
#SBATCH -o %x.o%j
#SBATCH -A CFD116
#SBATCH -t 30
#SBATCH -p batch
...
echo "Running with 8 ranks per node and 1 ranks per GPU on 256 nodes for a total of 2048 ranks and 2048 total GPUs with 2048 AMR-Wind ranks..."
