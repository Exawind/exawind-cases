...
#SBATCH -J amrwind-frontier-weak-scaling-5
#SBATCH -o %x.o%j
#SBATCH -A CFD116
#SBATCH -t 30
#SBATCH -p batch
...
echo "Running with 8 ranks per node and 1 ranks per GPU on 16 nodes for a total of 128 ranks and 128 total GPUs with 128 AMR-Wind ranks..."
